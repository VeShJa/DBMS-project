...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Functions~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        def iExit():
            iExit = tkinter.messagebox.askyesno("Reservoir DB", "Confirm if you want to eXiT")
            if iExit>0:
                root.destroy()
                return
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Frames~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        self.lblWater_level = Label(LeftFrame1, font = ('arial',12,'bold'), text = 'Water_level ', bd = 7, anchor='w', justify=LEFT)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TREEVIEW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        self.reservoirlist.heading("id", text = "id")
        self.reservoirlist.heading("Name", text = "Name")
        self.reservoirlist.heading("Water_level", text = "Water_level")

        self.reservoirlist['show'] = 'headings'
        self.reservoirlist.column("id", width = 20)
        self.reservoirlist.column("Name", width =  150)
        self.reservoirlist.column("Water_level", width = 100)
